          ...
          <div className="flex items-center gap-2 flex-wrap">
            {(
              [
                ...
                { id: 'claude_clean', label: 'Prose Cleanup' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="editor-card">
            <div className="editor-card-header">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold font-mono uppercase">Original Text</span>
              </div>
              {inputText && (
                <button
                  type="button"
            ...
            <textarea
              ...
              placeholder="Paste text to inspect selected invisible Unicode and copy artifacts..."
          ...
          <div className="editor-card">
            ...
            <textarea
              ...
              readOnly
              placeholder="Output with your selected cleanup rules applied will appear here..."
